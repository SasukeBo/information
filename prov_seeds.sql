INSERT INTO privilege(sign, priv_type, name) values
  ...
  ('device_u', 2, '更新设备信息'),
  ('device_d', 2, '删除设备'),
  ('device_charge_c', 2, '增加设备负责人'),
  ('device_charge_d', 2, '删除设备负责人'),
  ('device_charge_u', 2, '修改设备负责人'),
  ('device_charge_ability_c', 2, '增加负责人的权限'),
  ('device_charge_ability_d', 2, '删除负责人的权限'),
  ('device_param_c', 2, '增加检测参数'),
  ('device_param_u', 2, '修改检测参数'),
  ('device_param_d', 2, '删除检测参数');
